...
class PostServiceTest {
    ...
    void add_post() {
        ...
        assertEquals(post.getContent(), "컨텐츠");
    ...
    void post_update(){
        ...
        ReqAddPostDto reqAddPostDto = new ReqAddPostDto("제목2","카테고리2","내용2");
        postService.update(postId,reqAddPostDto);

        assertEquals(post.getContent(),"내용2");
